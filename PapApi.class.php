 ...
 *   Generated on: 2021-04-19 08:19:27
 *   PAP version: 5.10.3.1, GPF version: 1.3.66.0
 *   
 */


define('PAP_API_VERSION', '1.0.0.2');
...
if (!class_exists('Gpf_Api_Session', false)) {
  class Gpf_Api_Session extends Gpf_Object {
  	 ...
  	 * @return boolean true if user was successfully logged
  	 */
      private function authenticateRequest($username, $password, $authtoken, $roleType = self::MERCHANT, $languageCode = null, $twofactorToken = null) {
